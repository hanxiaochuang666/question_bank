...
import cn.eblcu.questionbank.persistence.entity.dto.User;
import cn.eblcu.questionbank.ui.model.UserToken;
...
public class SupperTokenUtils {
     ...
     * @return
     */
    public static int getUserByToken(HttpServletRequest HttpServletRequest)throws Exception{
        String token = HttpServletRequest.getHeader("token");
        if(StringUtils.isEmpty(token)){
            logger.info("请求头信息中没有token");
            return -1;
        }
        //1.使用自己的私钥解密
